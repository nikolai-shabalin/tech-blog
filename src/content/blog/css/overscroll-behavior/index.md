...
После того как вы поняли как работает цепочка скролов активируйте "overscroll-behavior" в правом верхнем углу блока и начните сколить заново. Ощутите разницу. Скрол перестал передаваться по цепочке!
